    ...
    public partial class frmSplash : Form
    {
        ...
        private bool EncontroNuevoVersion()
        {
            ...
            try
            {
                ...
                //descargar de archivo Actualizacion.
        ...
        private void IniciarVentanaSplash()
        {
            ...
            {                
                Util.ShowError("Error al conexion con servidor :" + exSql.Message);
            }
            catch (Exception ex)
            {                
        ...
        {
            Acceso.frmLogin frmIngreso = new Acceso.frmLogin();
            frmIngreso.Show();
            this.Hide();
        }
        private void IniciarActualizador()
        {
            ...
            try
            {
                ...
                //inicio de ejecutable de actualizacion
                //Desde la aplicacion de actualizacion debemos cerar la aplicacion
                 
                 Process.Start(rutaEjecutable, datosconcatenados);

                ////Salir de la aplicacion actual de asistencia
                //Application.Exit();
            }
            catch (Exception ex)
            {
        ...
        private void frmSplash_Shown(object sender, EventArgs e)
        {
            ...
            {
                backgroundWorker1.RunWorkerAsync(); //Ejecuta el evento backgroundWorker1_DoWork
            }      
        }
        ...
        private bool DescagarArchivosActualizacion()
        {
